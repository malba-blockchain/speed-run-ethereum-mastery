...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  /*
  const transferTransaction2 = await yourToken.transfer(
    "0x5f8eC1dB69713D035D2B7D7B6c5db0d6789ee97c", //This is a custom wallet. Otherwise minted funds go to the OG msg.sender
    ethers.utils.parseEther("1000")
  );
  */
  ...
  const ownershipTransaction = await vendor.transferOwnership("0x5f8eC1dB69713D035D2B7D7B6c5db0d6789ee97c");
  console.log("\n    ✅ confirming...\n");
